...
def setup_training_config(preset='edm2-img512-s', **opts):
    ...
    try:
        ...
        c.val_kwargs.num_classes = dataset_obj.label_dim  # ensure val labels match training label_dim
...
@click.option('--fpus23',           help='Path to FPUS23 dataset (optional)', metavar='DIR',    type=str, default=None)
@click.option('--african',          help='Path to African Zenodo dataset root (optional)', metavar='DIR', type=str, default=None)
@click.option('--fetal-abdomen',    help='Path to fetal abdominal segmentation IMAGES dir (optional)', metavar='DIR', type=str, default=None)
