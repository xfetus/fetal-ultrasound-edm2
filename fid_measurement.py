...
def main():
    ...
    parser.add_argument('--tian', action='store_true', help='Use Tian et al. class index mapping for fake image directories')
    ...
    for class_id, class_name in plane_classes.items():
        ...
        fake_dir = os.path.join(args.fake_root, f'diffusion_samples_FETAL_cond_{cond_id}')
